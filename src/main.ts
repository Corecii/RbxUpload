...
const cmdOptionsDefinitions = [
    ...
    { name: "skip", type: oneOf(skipValues), multiple: true, description: "Skip interactive prompts for specific values. Valid values: " + skipValues.join(", ")},
    { name: "group", type: Number, description: "Group to upload to"},
    { name: "type", type: oneOf(assetTypeValues), description: "Type of asset to upload as. Valid values: " + assetTypeValues.join(", ")},
    // { name: "id", type: Number, description: "Existing asset id to upload to"},
    { name: "name", type: String, description: "Name of asset. '$file' will be replaced with the file name. Defaults to $file"},
    { name: "description", type: String, description: "Description of asset. Supports $file. Defaults to <blank>"},
    { name: "name-retry", type: String, description: "Fallback name if upload fails due to text filtering. Does not support $file."},
    { name: "description-retry", type: String, description: "Fallback description if upload fails due to text filtering. Does not support $file."},
